...
const Footer = () => {
  return (
    ...
    <div className="text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] mt-12 py-6">
        <p>© 2025 Anuruag Pradhan. All rights reserved.</p>
        <ul className="flex items-center gap-10 justify-center mt-4 sm:mt-0">
            <li><a target='_blank' href="https://github.com/anurag965">GitHub</a></li>
            <li><a target='_blank' href="https://www.linkedin.com/in/anurag-pradhan-0340bb288/">LinkedIn</a></li>
        </ul>
    </div>
 </div>
  )
